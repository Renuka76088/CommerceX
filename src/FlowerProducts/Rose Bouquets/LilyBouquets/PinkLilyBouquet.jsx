...
import Flower1 from ".././../../assets/PinkLily (1).avif";
import Flower2  from ".././../../assets/PinkLily (1).jpg";
import Flower3  from ".././../../assets/PinkLily (1).webp";
import Flower4  from ".././../../assets/PinkLily (2).jpg";



const categories = [
  { name: "Simple Pink Lily Bouquet", img: Flower1 },
  { name: "Premium Pink Lily Bouquet", img: Flower2 },
  { name: "Simple Pink Lily Bouquet", img:Flower3 },
  { name: "Large Pink Lily Bouquet", img: Flower4 },
  
];

const products = [
  { title: "Simple Pink Lily Bouquet", price: "₹595", img:Flower1 },
  { title: "Premium Pink Lily Bouquet", price: "₹595", img: Flower2 },
  { title: "Simple Pink Lily Bouquet", price: "₹695", img: Flower3},
  { title: "Large Pink Lily Bouquet", price: "₹795", img: Flower4 },
 
  
];

const PinkLilyBouquet = () => {
  return (
...
export default PinkLilyBouquet;