...
import Flower1 from "../assets/Rose Flower Box.png";
import Flower2 from "../assets/Mixed Flower Box.png";
import Flower3 from "../assets/Luxury Flower Box.png";
import Flower4 from "../assets/Heart Shape Flower Box.png";

const categories = [
  { name: "Rose Flower Box", img: Flower1 },
  { name: "Mixed Flower Box", img: Flower2 },
  { name: "Luxury Flower Box", img: Flower3 },
  { name: "Heart Shape Flower Box", img: Flower4 },
];

const products = [

  // Rose Flower Box
  { title: "Pastel Blooms Of Serenity", price: "₹595", img: Flower1, category: "Rose Flower Box" },


  // Mixed Flower Box
  { title: "Mixed Flower Surprise Box", price: "₹595", img: Flower2, category: "Mixed Flower Box" },

  // Luxury Flower Box
  { title: "Whispers Of Affection Pink Roses", price: "₹695", img: Flower3, category: "Luxury Flower Box" },

  // Heart Shape Flower Box
  { title: "Chic Rose Birthday Box", price: "₹795", img: Flower4, category: "Heart Shape Flower Box" },
];

const FlowerBoxes = () => {

  const [selectedCategory, setSelectedCategory] = useState("Rose Flower Box");
