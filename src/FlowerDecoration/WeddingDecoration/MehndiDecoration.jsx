...
import Mehendi3  from "../../assets/Mehendi (3).png";



const categories = [
  { name: "Traditional / Classic Mehndi Decoration", img: Mehendi1 },
  { name: " Royal / Grand Mehndi Decoration", img: Mehendi2 },
  { name: " Theme-Based Mehndi Decoration", img:Mehendi3 },

];

const products = [
  { title: "Traditional / Classic Mehndi Decoration", price: "₹595", img:Mehendi1 },
  { title: " Royal / Grand Mehndi Decoration", price: "₹595", img: Mehendi2 },
  { title: " Theme-Based Mehndi Decoration", price: "₹695", img: Mehendi3},

  
];

const  MehndiDecoration = () => {
  return (
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-3xl font-semibold">
              Beautiful Mehendi decoration
            </h1>

            <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 mt-2">
              <span>40 Mehendi Products</span>
...
export default MehndiDecoration;
