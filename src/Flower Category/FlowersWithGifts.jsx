...
import Flower1 from "../assets/enchanting-flower-for-mom-9779500fl-C.avif";


const products = [
  { title: "Flower With Gifts", price: "₹595", img:Flower1 },

  
];

const FlowersWithGifts = () => {
  return (
...
export default FlowersWithGifts;