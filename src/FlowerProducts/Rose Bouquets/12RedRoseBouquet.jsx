...
const categories = [
  { name: "12 Rose Bouquet", img: Rosei1 },
  { name: "12 Rose", img: Rosei2 },
  { name: "Birthday 12 Rose", img:Rosei3 },
 
];

const products = [
  { title: "Pastel Blooms Of Serenity", price: "₹595", img:Rosei1 },
  { title: "12 Red Roses Bouquet", price: "₹595", img: Rosei2 },
  { title: "Whispers Of Affection Red Roses", price: "₹695", img: Rosei3},

  
];

const RedRoseBouquet12 = () => {
  return (
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-3xl font-semibold">
              Beautiful 12 Rose Bouquets
            </h1>

            <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 mt-2">
              <span>40 Rosei Products</span>
...
export default RedRoseBouquet12;