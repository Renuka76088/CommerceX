...
import Anniversary2  from "../../../assets/Anniversary (2).png";
import Anniversary3  from "../../../assets/Anniversary (3).png";



const categories = [
  { name: "Themed Anniversary Decoration", img: Anniversary1 },
  { name: "Romantic / Classic Anniversary Decoration", img: Anniversary2 },
  { name: " Modern / Minimalist Anniversary Decoration ", img:Anniversary3 },

];

const products = [
  { title: "Themed Anniversary Decoration", price: "₹595", img:Anniversary1 },
  { title: "Romantic / Classic Anniversary Decoration", price: "₹595", img: Anniversary2 },
  { title: " Modern / Minimalist Anniversary Decoration ", price: "₹695", img: Anniversary3},

  
];

const  AnniversaryDecoration = () => {
  return (
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-3xl font-semibold">
              Beautiful Anniversary decoration
            </h1>

            <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 mt-2">
              <span>40 Anniversary Products</span>
...
export default AnniversaryDecoration;
