...
import Rose1 from ".././../assets/Rose100.png";
import Rose2  from ".././../assets/Rose 100 (2).png";
import Rose3  from ".././../assets/Rose 100 (3).png";



const categories = [
  { name: "100 Red Rose Bouquet", img: Rose1 },
  { name: "100 Mix Colour Roses Bouquet", img: Rose2 },
  { name: "100 Dark Colour Roses Bouquet", img:Rose3 },

];

const products = [
  { title: "100 Red Rose Bouquet", price: "₹595", img:Rose1 },
  { title: "100 Mix Colour Roses Bouquet", price: "₹595", img: Rose2 },
  { title: "100 Dark Colour Roses Bouquet", price: "₹695", img: Rose3},

  
];

const RedRoseBouquet100 = () => {
  return (
...
export default RedRoseBouquet100;