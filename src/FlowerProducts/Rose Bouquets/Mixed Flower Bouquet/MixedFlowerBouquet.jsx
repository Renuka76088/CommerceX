...
import Flower1 from ".././../../assets/MixFlower (1).png";
import Flower2  from ".././../../assets/MixFlower (1).webp";
import Flower3  from ".././../../assets/MixFlower (2).png";
import Flower4  from ".././../../assets/MixFlower (3).png";



const categories = [
  { name: "Lily & Roses", img: Flower1 },
  { name: "Mix Bunch", img: Flower2 },
  { name: "Roses & Carnation", img:Flower3 },
  { name: "Mix Bouquet Bunch ", img: Flower4 },

];

const products = [
  { title: "Lily & Roses", price: "₹595", img:Flower1 },
  { title: "Mix Bunch", price: "₹595", img: Flower2 },
  { title: "Roses & Carnation", price: "₹695", img: Flower3},
  { title: "Mix Bouquet Bunch", price: "₹795", img: Flower4 },

  
];

const MixedFlowerBouquet = () => {
  return (
...
export default MixedFlowerBouquet;