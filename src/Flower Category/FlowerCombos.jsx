...
import Flower1 from "../assets/Checklate cake.jpg";
import Flower2 from "../assets/Flowers With Chocolate.jpg";
import Flower3 from "../assets/Flowers With Teddy.webp";
import Flower4 from "../assets/Flowers With Gifts.jpg";

const categories = [
  { name: "Flowers With Cake", img: Flower1 },
  { name: "Flowers With Chocolate", img: Flower2 },
  { name: "Flowers With Teddy", img: Flower3 },
  { name: "Flowers With Gifts", img: Flower4 },
];

const products = [

  // Flowers With Cake
  { title: "Pastel Blooms With Chocolate Cake", price: "₹595", img: Flower1, category: "Flowers With Cake" },

  // Flowers With Chocolate
  { title: "Roses With Chocolate Box", price: "₹595", img: Flower2, category: "Flowers With Chocolate" },

  // Flowers With Teddy
  { title: "Pink Roses With Cute Teddy", price: "₹695", img: Flower3, category: "Flowers With Teddy" },

  // Flowers With Gifts
  { title: "Birthday Flower Gift Combo", price: "₹795", img: Flower4, category: "Flowers With Gifts" },

];

const FlowerCombos = () => {

  const [selectedCategory, setSelectedCategory] = useState("Flowers With Cake");
