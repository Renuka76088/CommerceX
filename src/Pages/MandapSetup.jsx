...
import Mandap1 from "../assets/Mandap (1).png";
import Mandap2  from "../assets/Mandap (2).png";
import Mandap3  from "../assets/Mandap (3).png";
import Mandap4  from "../assets/Mandap (4).png";
import Mandap5 from "../assets/Mandap (5).png";
import Mandap6 from "../assets/Mandap (6).png";


const categories = [
  { name: "Theme-Based Floral Mandap", img: Mandap1 },
  { name: "Traditional Marigold Mandap", img: Mandap2 },
  { name: " Hanging Floral Mandap", img:Mandap4 },
  { name: " Garden Style Floral Mandap", img: Mandap5 },
  { name: "Floral Canopy Mandap", img: Mandap3 },
  { name: "Floral Pillar Mandap", img: Mandap6 },
];

const products = [
  { title: "Theme-Based Floral Mandap", price: "₹595", img:Mandap1 },
  { title: "Traditional Marigold Mandap", price: "₹595", img: Mandap2 },
  { title: " Hanging Floral Mandap", price: "₹695", img: Mandap4},
  { title: "Floral Canopy Mandap", price: "₹795", img: Mandap3 },
  { title: " Garden Style Floral Mandap", price: "₹899", img: Mandap5 },
  { title: "Floral Pillar Mandap", price: "₹799", img: Mandap6 },
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-3xl font-semibold">
              Beautiful Flower Mandap Decoration
            </h1>
