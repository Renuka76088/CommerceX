      ...
      <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
        ...
        <div>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Prakash Florist is a trusted flower shop known for delivering fresh
            flowers and beautiful gifts for every occasion. We specialize in
            creating elegant bouquets, gift hampers and floral decorations that
            make your moments special.
          </p>

          <p className="text-gray-600 leading-relaxed">
            Whether it’s a birthday, anniversary, wedding or festival, our team
            carefully designs every order with love and creativity to bring
