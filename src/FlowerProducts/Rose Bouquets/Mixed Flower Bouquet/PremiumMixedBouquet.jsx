...
import Flower1 from ".././../../assets/Premium (1).jpg";
import Flower2  from ".././../../assets/Premium (1).webp";
import Flower3  from ".././../../assets/Premium (2).jpg";
import Flower4  from ".././../../assets/Premium (3).jpg";
import Flower5 from ".././../../assets/Premium (4).jpg";



const categories = [
  { name: "Luxury Rose & Orchid Bouquet", img: Flower1 },
  { name: "Rose, Lily & Carnation Bouquet", img: Flower2 },
  { name: "Exotic Flower Mixed Bouquet", img:Flower3 },
  { name: "Pastel Premium Bouquet", img: Flower4 },
  { name: "Bright Premium Mixed Bouquet", img: Flower5 },

];

const products = [
  { title: "Luxury Rose & Orchid Bouque", price: "₹595", img:Flower1 },
  { title: "Rose, Lily & Carnation Bouquet", price: "₹595", img: Flower2 },
  { title: "Exotic Flower Mixed Bouquet", price: "₹695", img: Flower3},
  { title: "Pastel Premium Bouquet", price: "₹795", img: Flower4 },
  { title: "Bright Premium Mixed Bouquet", price: "₹899", img: Flower5 },
 
  
];

const PremiumMixedBouquet = () => {
  return (
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-3xl font-semibold">
              Beautiful Premium Mixed Flower Bouquets
            </h1>
...
export default PremiumMixedBouquet;