...
import WeddingStage2  from "../assets/WeddingStage (2).png";
import WeddingStage3  from "../assets/WeddingStage (3).png";


const categories = [
  { name: "Traditional / Classic Wedding Stage", img: WeddingStage2 },
  { name: " Royal / Grand Wedding Stage", img: WeddingStage3 },
  { name: " Theme-Based Wedding Stage ", img:WeddingStage1 },

];

const products = [
  { title: "Traditional / Classic Wedding Stage", price: "₹595", img:WeddingStage2 },
  { title: " Royal / Grand Wedding Stage", price: "₹595", img: WeddingStage3 },
  { title: " Theme-Based Wedding Stage ", price: "₹695", img: WeddingStage1},
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-3xl font-semibold">
              Beautiful WeddingStage decoration
            </h1>

            <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 mt-2">
              <span>40 WeddingStage Products</span>
