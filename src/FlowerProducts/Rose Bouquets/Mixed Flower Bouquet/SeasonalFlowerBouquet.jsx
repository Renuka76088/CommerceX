...
import Flower1 from ".././../../assets/Seasonale (1).jpg";
import Flower2  from ".././../../assets/Seasonale (1).png";
import Flower3  from ".././../../assets/Seasonale (1).webp";
import Flower4  from ".././../../assets/Seasonale (2).jpg";
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-3xl font-semibold">
              Seasonal Beautiful Flower Bouquets
            </h1>
...
export default SeasonalFlowerBouquet;