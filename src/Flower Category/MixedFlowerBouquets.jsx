...
import Flower1 from "../assets/mixed-flower-bouquets.png";


const products = [
  { title: " Mixed Flower Bouquets", price: "₹595", img:Flower1 },
  
];

const MixedFlowerBouquets = () => {
  return (
...
export default MixedFlowerBouquets;