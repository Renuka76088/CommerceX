...
import Haldi3  from "../../assets/Haldi (3).png";
import Haldi4  from "../../assets/Haldi (4).png";



const categories = [
  { name: "Royal / Grand Haldi Decoration", img: Haldi1 },
  { name: "Traditional Floral Haldi Decoration", img: Haldi2 },
  { name: "Modern Haldi", img:Haldi3 },
  { name: "Contemporary Haldi", img: Haldi4 },
];

const products = [
  { title: "Royal / Grand Haldi", price: "₹595", img:Haldi1 },
  { title: "Traditional Floral Haldi", price: "₹595", img: Haldi2 },
  { title: "Modern Haldi", price: "₹695", img: Haldi3},
  { title: "Contemporary Haldi", price: "₹795", img: Haldi4 },
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-3xl font-semibold">
              Beautiful Haldi Decoration
            </h1>

            <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 mt-2">
              <span>40 Haldi Products</span>
