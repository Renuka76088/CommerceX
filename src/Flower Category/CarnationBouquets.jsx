...
import Flower1 from "../assets/carnation-bouquets.png";


const products = [
  { title: " Carnation Bouquets", price: "₹595", img:Flower1 },
  
];

const CarnationBouquets = () => {
  return (
...
export default CarnationBouquets;