...
import Flower1 from "../assets/Seasonale (1).webp";
import Flower2 from "../assets/Seasonale (1).jpg";
import Flower3 from "../assets/Seasonale (2).jpg";

const categories = [
  { name: "All", img: Flower1 },
  { name: "Mixed Flower Bouquet", img: Flower1 },
  { name: "Seasonal Flower Bouquet", img: Flower2 },
  { name: "Premium Mixed Bouquet", img: Flower3 },
];
...
const products = [
...

  {
    ...
    price: "₹595",
    img: Flower2,
    category: "Seasonal Flower Bouquet",
  },

  {
    ...
    price: "₹695",
    img: Flower3,
    category: "Premium Mixed Bouquet",
  },
];
