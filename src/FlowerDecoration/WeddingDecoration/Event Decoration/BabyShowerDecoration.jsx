...
import BabyShower2  from "../../../assets/BabyShower (2).png";
import BabyShower3  from "../../../assets/BabyShower (3).png";



const categories = [
  { name: "Gender Reveal / Themed Baby", img: BabyShower1 },
  { name: "Cute & Cozy Baby Shower", img: BabyShower2 },
  { name: "Baby Shower Decoration", img:BabyShower3 },

];

const products = [
  { title: "Gender Reveal / Themed Baby", price: "₹595", img:BabyShower1 },
  { title: "Cute & Cozy Baby Shower", price: "₹595", img: BabyShower2 },
  { title: "Baby Shower Decoration", price: "₹695", img: BabyShower3},
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-3xl font-semibold">
              Beautiful BabyShower decoration
            </h1>

            <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 mt-2">
              <span>40 BabyShower Products</span>
