...
const categories = [
  { name: "Floral Arch Decoration", img: Birthday1 },
  { name: " Flower Wall Backdrop", img: Birthday2 },
  { name: " Floral Balloon Combo ", img:Birthday4 },
  { name: " Pastel & Gold Entrance ", img: Birthday5 },
  { name: "Minimalist Floral Arrangement", img: Birthday3 },
  { name: "Hanging Floral Decor", img: Birthday6 },
];

const products = [
  { title: "Floral Arch Decoration", price: "₹595", img:Birthday1 },
  { title: " Flower Wall Backdrop", price: "₹595", img: Birthday2 },
  { title: " Floral Balloon Combo", price: "₹695", img: Birthday4},
  { title: "Minimalist Floral Arrangement", price: "₹795", img: Birthday3 },
  { title: " Pastel & Gold Entrance", price: "₹899", img: Birthday5 },
  { title: "Hanging Floral Decor", price: "₹799", img: Birthday6 },
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-3xl font-semibold">
              Beautiful Flower Birthday Decoration
            </h1>
