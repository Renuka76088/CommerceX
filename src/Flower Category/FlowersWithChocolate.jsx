...
import Flower1 from "../assets/Flowers With Chocolate.jpg";



const products = [
  { title: " Flower With Choclate", price: "₹595", img:Flower1 },
  
];

const FlowersWithChocolate = () => {
  return (
...
export default FlowersWithChocolate;