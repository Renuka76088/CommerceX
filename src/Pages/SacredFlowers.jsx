...
import Pavitra1 from "../assets/Pavitra (1).png";
import Pavitra2  from "../assets/Pavitra (2).png";
import Pavitra3  from "../assets/Pavitra (3).png";
import Pavitra4  from "../assets/Pavitra (4).png";
import Pavitra5 from "../assets/Pavitra (5).png";
import Pavitra6 from "../assets/Pavitra (6).png";


const categories = [
  { name: " Floral Kalash Decoration", img: Pavitra6 },
  { name: " Flower Rangoli Decoration", img: Pavitra2 },
  { name: "Floral Mandap Decoration", img:Pavitra4 },
  { name: "Flower Idol Decoration", img: Pavitra5 },
  { name: "Hanging Flower Strings", img: Pavitra3 },
  { name: " Floral Garland Decoration", img: Pavitra1 },
];

const products = [
  { title: " Floral Kalash Decoration", price: "₹595", img:Pavitra6 },
  { title: " Flower Rangoli Decoration", price: "₹595", img: Pavitra2 },
  { title: " Floral Mandap Decoration", price: "₹695", img: Pavitra4},
  { title: "Hanging Flower Strings", price: "₹795", img: Pavitra3 },
  { title: " Flower Idol Decoration", price: "₹899", img: Pavitra5 },
  { title: "  Floral Garland Decoration", price: "₹799", img: Pavitra1 },
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl md:text-3xl font-semibold">
              Beautiful Flower SacredFlowers Decoration
            </h1>
