...
export default function FlowerDecoration() {
    ...
    const [activeCategory1, setActiveCategory1] = useState(categories1[0]);
    const [activeCategory2, setActiveCategory2] = useState(categories2[0]);
    const [activeCategory3, setActiveCategory3] = useState(categories3[0]);

    /* FILTER PRODUCTS */
    const filteredProducts1 = products.filter(
        (p) => p.category === activeCategory1
    );

    const filteredProducts2 = products.filter(
        (p) => p.category === activeCategory2
    );

    const filteredProducts3 = products.filter(
        (p) => p.category === activeCategory3
    );
    ...
    return (
        <>
            <div className="space-y-16">
                ...
                {/* SECTION 1 */}
                <div className="py-12 px-4 md:px-6 bg-gray-100">
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-3 mb-6 no-scrollbar">
                        {categories1.map((cat, i) => (
                            <button
                                key={i}
                                onClick={() => setActiveCategory1(cat)}
                ...
                <div className="py-12 px-4 md:px-6 bg-gray-100">
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-3 mb-6 no-scrollbar">
                        {categories2.map((cat, i) => (
                            <button
                                key={i}
                                onClick={() => setActiveCategory2(cat)}
                                className={`px-5 py-2 rounded-full whitespace-nowrap text-sm font-medium transition
${activeCategory2 === cat
                                        ? "bg-teal-600 text-white shadow-md"
                                        : "bg-white text-gray-700 border hover:bg-gray-50"
                ...
                <div className="py-12 px-4 md:px-6 bg-gray-100">
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-3 mb-6 no-scrollbar">
                        {categories3.map((cat, i) => (
                            <button
                                key={i}
                                onClick={() => setActiveCategory3(cat)}
                                className={`px-5 py-2 rounded-full whitespace-nowrap text-sm font-medium transition
${activeCategory3 === cat
                                        ? "bg-teal-600 text-white shadow-md"
                                        : "bg-white text-gray-700 border hover:bg-gray-50"
