...
import Flower1 from "../assets/Gemini_Generated_Image_qm6tntqm6tntqm6t.png";




const products = [
  { title: "Marigold-Garlands", price: "₹595", img:Flower1 },

  
];

const MarigoldGarlands = () => {
  return (
...
export default MarigoldGarlands;