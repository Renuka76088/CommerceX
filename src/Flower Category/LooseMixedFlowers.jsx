...
import Flower1 from "../assets/Loose Mixed Flowers.png";



const products = [
  { title: "Loose Mixed Flowers", price: "₹595", img:Flower1 },
  
  
];

const LooseMixedFlowers = () => {
  return (
...
export default LooseMixedFlowers;