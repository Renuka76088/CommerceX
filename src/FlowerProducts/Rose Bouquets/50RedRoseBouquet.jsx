...
import Rose1 from ".././../assets/Rose 50.png";
import Rose2  from ".././../assets/Rose50 (1).png";
import Rose3  from ".././../assets/Rose50 (2).png";



const categories = [
  { name: "50 Red Roses", img: Rose1 },
  { name: "50 Pink Roses", img: Rose2 },
  { name: "50 Mix Colours Roses", img:Rose3 },

];

const products = [
  { title: "50 Red Roses", price: "₹595", img:Rose1 },
  { title: "50 Pink Roses", price: "₹595", img: Rose2 },
  { title: "50 Mix Colours Roses", price: "₹695", img: Rose3},
 
  
];

const RedRoseBouquet50 = () => {
  return (
...
export default RedRoseBouquet50;