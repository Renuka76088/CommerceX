...
import Flower2  from ".././../../assets/White Lily (1).webp";
import Flower3  from ".././../../assets/White Lily (2).jpg";



const categories = [
  { name: "Designer White Lily Bouquet", img: Flower1 },
  { name: "Premium White Lily Bouquet", img: Flower2 },
  { name: "Simple White Lily Bouquet", img:Flower3 },

];

const products = [
  { title: "Designer White Lily Bouquet", price: "₹595", img:Flower1 },
  { title: "Premium White Lily Bouquet", price: "₹595", img: Flower2 },
  { title: "Simple White Lily Bouquet", price: "₹695", img: Flower3},
  
  
];

const WhiteLilyBouquet = () => {
  return (
...
export default WhiteLilyBouquet;