...
import Flower3 from "../assets/Jasmine Flowers.png";
import Flower4 from "../assets/Loose Mixed Flowers.png";

const categories = [
  { name: "Rose Petals", img: Flower1 },
  { name: "Marigold Flowers", img: Flower2 },
  { name: "Jasmine Flowers", img: Flower3 },
  { name: "Loose Mixed Flowers", img: Flower4 },
];

const products = [

  // Rose Petals
  { title: "Fresh Rose Petals Pack", price: "₹595", img: Flower1, category: "Rose Petals" },

  // Marigold Flowers
  { title: "Fresh Marigold Flowers", price: "₹595", img: Flower2, category: "Marigold Flowers" },

  // Jasmine Flowers
  { title: "Fragrant Jasmine Flowers", price: "₹695", img: Flower3, category: "Jasmine Flowers" },

  // Loose Mixed Flowers
  { title: "Loose Mixed Flower Pack", price: "₹795", img: Flower4, category: "Loose Mixed Flowers" },

];

const LooseFlowers = () => {

  const [selectedCategory, setSelectedCategory] = useState("Rose Petals");
