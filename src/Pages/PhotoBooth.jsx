...
import Photoboot1 from "../assets/Photoboot.png";
import Photoboot2  from "../assets/Photoboot2.png";
import Photoboot3  from "../assets/Photoboot3.png";
import Photoboot4  from "../assets/Photoboot4.png";
import Photoboot5 from "../assets/Photoboot5.png";
import Photoboot6 from "../assets/Photoboot6.png";


const categories = [
  { name: "square flower wall backdrop", img: Photoboot1 },
  { name: " Mixed Material Floral Setup", img: Photoboot2 },
  { name: " Thematic / Customized Floral Decor ", img:Photoboot4 },
  { name: " Minimalist Floral Arrangement ", img: Photoboot5 },
  { name: "Flower Arch / Floral Frame", img: Photoboot3 },
  { name: "Hanging Floral Decor", img: Photoboot6 },
];

const products = [
  { title: "square flower wall backdrop", price: "₹595", img:Photoboot1 },
  { title: " Mixed Material Floral Setup", price: "₹595", img: Photoboot2 },
  { title: " Thematic / Customized Floral Decor", price: "₹695", img: Photoboot4},
  { title: "Flower Arch / Floral Frame ", price: "₹795", img: Photoboot3 },
  { title: " Minimalist Floral Arrangement", price: "₹899", img: Photoboot5 },
  { title: "Hanging Floral Decor", price: "₹799", img: Photoboot6 },
