...
import Flower1 from "../assets/Rose Garlands.png";
import Flower2 from "../assets/Marigold Garlands.png";
import Flower3 from "../assets/Jasmine Garlands.png";
import Flower4 from "../assets/Wedding Garlands.png";

const categories = [
  { name: "Rose Garlands", img: Flower1 },
  { name: "Marigold Garlands", img: Flower2 },
  { name: "Jasmine Garlands", img: Flower3 },
  { name: "Wedding Garlands", img: Flower4 },
];

const products = [

  // Rose Garlands
  { title: "Fresh Rose Garland", price: "₹595", img: Flower1, category: "Rose Garlands" },

  // Marigold Garlands
  { title: "Traditional Marigold Garland", price: "₹595", img: Flower2, category: "Marigold Garlands" },

  // Jasmine Garlands
  { title: "Fragrant Jasmine Garland", price: "₹695", img: Flower3, category: "Jasmine Garlands" },

  // Wedding Garlands
  { title: "Premium Wedding Flower Garland", price: "₹795", img: Flower4, category: "Wedding Garlands" },

];

const FlowerGarlands = () => {

  const [selectedCategory, setSelectedCategory] = useState("Rose Garlands");
